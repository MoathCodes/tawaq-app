...
''';
      ...
      expect(blocks[1].citations.first, contains('تحفة الأحوذي'));
      expect(blocks[1].citations.first, contains('\u2066'));

      expect(blocks[2].listNumber, 7);
      expect(blocks[2].citations, isEmpty);

      expect(blocks[3].listNumber, 8);
      expect(blocks[3].citations.first, contains('تفسير الطبري'));
      expect(blocks[3].citations.first, contains('\u2066'));
