        ...
        child: Column(
                ...
                children: [
                  ...
                  if (isSearchMode)
                    FButton.icon(
                      ...
                      semanticsLabel: desktop ? null : l10n.bookmarks,
                      child: desktop
                          ? Row(
                              mainAxisSize: MainAxisSize.min,
                              spacing: AppSpacing.xs,
          ...
          if (isSearchMode) ...[
            ...
            if (fieldQuery.trim().isEmpty) ...[
              if (activeFilterCount > 0) const SizedBox(height: AppSpacing.md),
              _RecentSearches(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FButton(
                    ...
                    size: FButtonSizeVariant.sm,
                    mainAxisSize: MainAxisSize.min,
                    semanticsLabel: hadithRecentSearchChipSemanticsLabel(
                      query,
                      l10n,
                    ),
                    onPress: interactionsEnabled
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Color.lerp(colors.secondary, colors.primary, 0.1),
          borderRadius: theme.radii.md,
          border: Border.all(
            color: Color.lerp(colors.border, colors.primary, 0.35)!,
          ),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          ...
          children: [
            _SearchMetaSectionHeader(
              ...
              title: l10n.hadithActiveFilters,
              trailing: desktop
                  ? FButton(
                      variant: FButtonVariant.ghost,
                      size: FButtonSizeVariant.sm,
                  ...
                  : FButton.icon(
                      ...
                      onPress: interactionsEnabled
                          ...
                          : null,
                      child: const HadithDecorExcludeSemantics(
                        child: Icon(FLucideIcons.rotateCcw, size: 14),
                      ),
                    ),
            ),
            SizedBox(
                  ...
                  return FButton(
                    ...
                    child: HadithDecorExcludeSemantics(
                      child: Row(
                        ...
                        spacing: AppSpacing.xs,
                        children: [
                          Text(chip.label, style: theme.typography.sm),
