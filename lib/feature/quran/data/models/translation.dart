...
class Translation {
  ...
  /// Returns a copy with presentation metadata from the translation source.
  Translation withSourceMetadata({required String? fontFamily}) {
    return Translation(
      id: id,
      sura: sura,
      aya: aya,
  ...
  /// Font family for rendering [translation], from the selected source.
