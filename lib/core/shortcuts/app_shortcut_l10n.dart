...
extension ShortcutDefL10n on ShortcutDef {
  ...
  String label(AppLocalizations l10n) => switch (id) {
        ...
        'quranZoomIn' => l10n.shortcutQuranZoomInLabel,
        'quranZoomOut' => l10n.shortcutQuranZoomOutLabel,
        'quranZoomReset' => l10n.shortcutQuranZoomResetLabel,
  ...
  String description(AppLocalizations l10n) => switch (id) {
        ...
        'quranZoomIn' => l10n.shortcutQuranZoomInDescription,
        'quranZoomOut' => l10n.shortcutQuranZoomOutDescription,
        'quranZoomReset' => l10n.shortcutQuranZoomResetDescription,
