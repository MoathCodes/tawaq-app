...
class IslamicTheme {
  ...
  static ColorScheme darkIslamic() {
    return ColorScheme(
      ...
      background: const HSLColor.fromAHSL(1, 28.0, 0.30, 0.15).toColor(),
      ...
      card: const HSLColor.fromAHSL(1, 30.0, 0.32, 0.19).toColor(),
      cardForeground: const HSLColor.fromAHSL(1, 42.0, 0.35, 0.88).toColor(),
      // Slightly elevated popover
      popover: const HSLColor.fromAHSL(1, 32.0, 0.28, 0.22).toColor(),
      ...
      primary: const HSLColor.fromAHSL(1, 35.0, 0.55, 0.50).toColor(),
      primaryForeground: const HSLColor.fromAHSL(1, 25.0, 0.35, 0.15).toColor(),
      // Better secondary with more warmth
      secondary: const HSLColor.fromAHSL(1, 30.0, 0.25, 0.25).toColor(),
      secondaryForeground:
          const HSLColor.fromAHSL(1, 42.0, 0.30, 0.78).toColor(),
      // Enhanced muted colors
      muted: const HSLColor.fromAHSL(1, 28.0, 0.22, 0.22).toColor(),
      ...
      input: const HSLColor.fromAHSL(1, 30.0, 0.25, 0.25).toColor(),
      // Golden ring to match primary
      ring: const HSLColor.fromAHSL(1, 35.0, 0.55, 0.50).toColor(),
      // Enhanced chart colors with better contrast
      chart1:
          const HSLColor.fromAHSL(1, 35.0, 0.60, 0.55).toColor(), // Warm gold
      chart2:
  ...
  static ColorScheme lightIslamic() {
    return ColorScheme(
      ...
      // Warm brown primary - like traditional Islamic calligraphy
      primary: const HSLColor.fromAHSL(1, 25.0, 0.40, 0.35).toColor(),
      primaryForeground: const HSLColor.fromAHSL(1, 40.0, 0.35, 0.97).toColor(),
      ...
      // Brown ring matching primary
      ring: const HSLColor.fromAHSL(1, 25.0, 0.40, 0.35).toColor(),
      // Chart colors inspired by manuscript illumination
      chart1: const HSLColor.fromAHSL(1, 25.0, 0.50, 0.45).toColor(), // Brown
      chart2: const HSLColor.fromAHSL(1, 45.0, 0.70, 0.55).toColor(), // Gold
